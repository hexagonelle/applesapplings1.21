...
//    // Creates a new BlockItem with the id "applesaplings:example_block", combining the namespace and path
...
//            .alwaysEdible().nutrition(1).saturationModifier(2f).build()));
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.applesaplings")) //The language key for the title of your CreativeModeTab
